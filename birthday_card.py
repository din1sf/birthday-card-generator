...
def generate_image(name):
    ...
    (such as a lion, an elephant, a giraffe, a flamingo, and a penguin) wearing party hats and gathered around a large birthday cake with colorful candles. 
...
# generate birthday card using template
...
name = "Niki"
page = generate_birthday_card(name)
